                                    ...
                                    <tr>
                                        <td align="center"
                                            ...
                                            <h2
                                                ...
                                                {{ trans('generals.thank_you_sub') }}
                                                {{ $exhibitor['name'] }}!<br>{{ trans('generals.order') }}
                                                {{ $paymentId }}
                                            </h2>
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        <td align="left" style="padding-top: 20px;">
                                            <table cellspacing="0" cellpadding="0" border="0" width="100%">
                                                <tr>
                                                    <td width="45%" align="left" bgcolor="#eeeeee"
                                                    ...
                                                    <td width="22%" align="left" bgcolor="#eeeeee"
                                                        style="font-size: 16px; font-weight: 800; line-height: 24px; padding: 10px;">
                                                ...
                                                <tr>
                                                    <td align="left" valign="top"
                                                        ...
                                                        <p style="font-weight: 800;">
                                                            {{ trans('generals.company_details') }}</p>
                                                        <ul>
